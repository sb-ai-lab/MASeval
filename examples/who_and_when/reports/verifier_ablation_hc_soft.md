# Who&When HC — verifier=soft

Generated: `2026-07-09 20:51:52`
...
| Field | Value |
|---|---|
| Experiment | Who&When HC — verifier=soft |
| Model / judge | Gemini |
...
- Agent localization: Hit Acc is 89.7%, Top-1 Acc is 53.4% (gap 36.2%). A large gap means the correct agent is often present but not ranked first.
...
|---:|---|---|---|---:|---|---|---:|---:|
| 1 | gemini_findings_50.json | WebSurfer | Orchestrator, Assistant | ❌ | 24 | 13, 14, 16, 15, 12, 11, … (+2) | ❌ | 2 |
| 2 | gemini_findings_51.json | WebSurfer |  | ❌ | 12 |  | ❌ | 1 |
| 3 | gemini_findings_16.json | Assistant | WebSurfer, Orchestrator, FileSurfer | ❌ | 82 | 50, 60, 64, 48, 52, 20, … (+33) | ❌ | 0 |
| 4 | gemini_findings_26.json | Assistant | WebSurfer | ❌ | 16 | 10 | ❌ | 0 |
| 5 | gemini_findings_45.json | Orchestrator | Assistant | ❌ | 18 | 14, 20, 13, 25, 27 | ❌ | 0 |
| 6 | gemini_findings_9.json | WebSurfer | WebSurfer, Orchestrator | ✅ | 16 | 0, 6, 12, 13, 2, 10 | ❌ | 6 |
| 7 | gemini_findings_39.json | WebSurfer | WebSurfer | ✅ | 8 | 4, 0 | ❌ | 5 |
| 8 | gemini_findings_41.json | FileSurfer | FileSurfer, Orchestrator, WebSurfer | ✅ | 4 | 13, 16, 11, 12, 14, 15, … (+3) | ❌ | 5 |
| 9 | gemini_findings_11.json | WebSurfer | Orchestrator, WebSurfer | ✅ | 4 | 15, 11, 12, 14, 17, 13, … (+5) | ❌ | 4 |
| 10 | gemini_findings_18.json | WebSurfer | Orchestrator, FileSurfer, WebSurfer | ✅ | 4 | 20, 11, 14, 15, 21, 24, … (+9) | ❌ | 3 |
| 11 | gemini_findings_24.json | WebSurfer | WebSurfer, Orchestrator | ✅ | 8 | 20, 10, 22, 12, 14, 16, … (+2) | ❌ | 3 |
| 12 | gemini_findings_53.json | Orchestrator | Orchestrator, WebSurfer | ✅ | 50 | 20, 30, 18, 38, 26, 12, … (+17) | ❌ | 3 |
| 13 | gemini_findings_15.json | FileSurfer | FileSurfer, Orchestrator, WebSurfer | ✅ | 32 | 19, 17, 15, 13, 14, 23, … (+10) | ❌ | 1 |
| 14 | gemini_findings_2.json | WebSurfer | WebSurfer, Orchestrator | ✅ | 8 | 30, 32, 34, 36, 31, 35, … (+14) | ❌ | 1 |
| 15 | gemini_findings_20.json | WebSurfer | Orchestrator, WebSurfer, Assistant | ✅ | 5 | 40, 20, 13, 39, 34, 16, … (+40) | ❌ | 1 |
| 16 | gemini_findings_25.json | Assistant | Orchestrator, Assistant, WebSurfer | ✅ | 51 | 0, 13, 19, 7, 14, 17, … (+4) | ❌ | 1 |
| 17 | gemini_findings_55.json | WebSurfer | Orchestrator, WebSurfer | ✅ | 8 | 16, 15, 10, 48, 39, 27, … (+36) | ❌ | 1 |
| 18 | gemini_findings_12.json | Orchestrator | Orchestrator, FileSurfer, Assistant, ComputerTerminal | ✅ | 51 | 26, 20, 30, 12, 14, 16, … (+27) | ❌ | 0 |
| 19 | gemini_findings_32.json | Orchestrator | Orchestrator, WebSurfer | ✅ | 18 | 15, 14, 13, 10, 16, 12, … (+1) | ❌ | 0 |
| 20 | gemini_findings_8.json | WebSurfer | WebSurfer, Orchestrator | ✅ | 8 | 23, 20, 16, 17, 15, 22, … (+2) | ❌ | 0 |

## Reproducibility

```json
{
  "experiment_name": "Who&When HC — verifier=soft",
  "model_name": "Gemini",
  ...
  "output_json_path": "/mnt/c/Users/barak/MASeval/examples/who_and_when/reports/verifier_ablation_hc_soft.json",
  "output_md_path": "/mnt/c/Users/barak/MASeval/examples/who_and_when/reports/verifier_ablation_hc_soft.md",
  "id_column": null,
  "agent_columns": null,
  "step_columns": null,
  "step_tolerance": 1,
