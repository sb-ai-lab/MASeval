...
async def main(gaia_eval, enable_tracing, name, name_v2 = None, result_folder_name: str = "judge_res"):
        ...
        if eval_input.agents_errors != None:
            ...
            if enable_tracing:
                with judge_client.start_as_current_span(
                    ...
                    output_dir = Path(__file__).parent / result_folder_name
                    output_dir.mkdir(exist_ok=True)
                    output_file = output_dir / Path(f"{task}.json")
